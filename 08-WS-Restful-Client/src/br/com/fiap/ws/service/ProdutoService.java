...
public class ProdutoService {
	...
	public void atualizar(Produto produto) throws Exception {
		WebResource w = client.resource(URL)
			...
			ClientResponse response = w
				...
				.put(ClientResponse.class, produto); //put é pra atualizar o produto
	...
	public void cadastrar(Produto produto) throws Exception {
		...
		ClientResponse response = w
				...
				.type("application/json")  //type é para mandar
	...
	public Produto pesquisar(int codigo) throws Exception {
		...
		ClientResponse response = w
			...
			//Recebe JSON
			.accept(MediaType.APPLICATION_JSON)
			.get(ClientResponse.class); // é o resultado que o server envia para nós
